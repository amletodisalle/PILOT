...
plot_cm(predictions, y_test, BASE_DIR + "multiclass/CNN-results/")
plot_history(loss, accuracy, val_loss, val_accuracy, BASE_DIR + "multiclass/CNN-results/")

np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Prediction.csv", predictions.T.astype(int), delimiter=",", fmt="%i")
np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Truth.csv", y_test.T.astype(int), delimiter=",", fmt="%i")
np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Loss.csv", loss.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Val_Loss.csv", val_loss.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Acc.csv", accuracy.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(BASE_DIR + "multiclass/CNN-results/CNN-Val_Acc.csv", val_accuracy.T.astype(float), delimiter=",", fmt="%f")
